 ...
 *    sends a full snapshot via the 'tabsChanged' bridge action. The strip mirrors
 *    pane 1's view of the world (tabStore.pane1Tabs): its own tabs, plus pane-2
 *    orphans adopted while split view is off. Orphans activate in pane 1 — never
