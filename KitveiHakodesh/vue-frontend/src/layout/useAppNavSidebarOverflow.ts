 ...
 * flat column (home, the destinations, workspaces, then its own controls), and whatever
 * the height cuts off, from the bottom up, moves into the flyout in that same order. The
