        ...
        <div :key="currentStep" class="step-root">
          ...
          <div v-if="currentStep === 'welcome'" class="step-welcome">
            ...
            <p class="welcome-note">
              אוצריא היא תוכנת לימוד תורה חינמית ופתוחה עם ספרייה ענפה של ספרי קודש. כתבי הקודש הוא
              תוסף עצמאי לאוצריא עבור וורד. משתמשי זית יכולים גם הם להשתמש בכתבי הקודש על ידי
              הגדרת הנתיב למסד הנתונים של זית.
            </p>
          </div>
